...
& $python ci/windows/patch_eigenpy.py $prefix
...
cl /nologo /Zs /MD /std:c++17 /EHsc /utf-8 /Zc:__cplusplus /DNOMINMAX /DPy_NO_LINK_LIB "/I$prefix/Library/include" "/I$prefix/Library/include/eigen3" "/I$prefix/Include" "/I$prefix/Lib/site-packages/numpy/_core/include" ci/windows/header_preflight.cpp
